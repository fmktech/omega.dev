...
Export `createSessionService` with the exact dependency object in `docs/implementation/runtime-contract.md`; resumed session headers persist the selected handoff and context artifact IDs.
